...
//    "fire and earth"
//};
//const vector<string> queries1 = {"milk", "water", "rock"};
...
//};
//
//const vector<string> queries2 = {"moscow is the capital of russia"};
...
//};
//
//vector<vector<string>> multi_docs;
//vector<vector<string>> multi_queries;
//vector<vector<string>> multi_expected;
//multi_docs.push_back(docs1);
//
//
//void TestFunctionalityMuli(
//  const vector<string>& docs,
//  const vector<string>& queries,
//  const vector<string>& expected
//)
